...
public class TestMqttCallBack implements MqttCallback {
    ...
    private static final Logger log = LoggerFactory.getLogger(TestMqttCallBack.class);
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
        ...
        mqttClient.publish(this.requestMessage.brokerMessage.messageId,mqttMessage);
